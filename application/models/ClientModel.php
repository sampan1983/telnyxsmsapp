...
class ClientModel extends CI_Model { 
	...
	$insert = "insert into tapp_tbl_clients(sender,first_name,last_name,email,country,date_time,address,postal_code,job_title,job_location,lead_date,interest_level,source,status,user_id,user_type) values('$mobile','$name','','$email','',now(),'$address','','$job_title','','','','','','".$_SESSION['id']."','".$_SESSION['type']."')";
	...
	function edit(){
		...
		$update = "update tapp_tbl_clients set email = '$email' , address = '$address' , sender = '$mobile' , first_name = '$name',job_title = '$job_title' , date_time=now() where id = '$id'";
