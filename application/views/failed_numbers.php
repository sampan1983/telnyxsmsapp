...
?>
                                ...
                                <td >
                                 ...
                                 <span class="error" style="color:red;" data-error="<?php echo $failed_data[$i]['error']; ?>"><?php echo substr($failed_data[$i]['error'],0,10); ?>..view logs</span>
                                </td>
...
<?php
                             ...
                             <td><a href="#" class="btn btn-danger delete" data-id = "'.$failed_data[$i]['id'].'"><i class="fa fa-trash-o"></i></a></td>
