...
<a href="Clients/export2"><button type="button" value="Export Data" class="btn btn-primary btn-md btn-sty sky-color"><i class="fa fa-file-excel-o" aria-hidden="true"></i>  Export Data</button></a>
